...
class email extends MX_Controller {
	...
	public function index() {
		//$this->send_email('shohiek@gmail.com', 'Hi', 'Testing email function');
		$this->send_email_func('shohiek@gmail.com','Hi','Testing email function',$attach_file=NULL,$bcc_email=NULL,$cc_email=NULL);
	}
	
	public function send_email($recipient, $subject, $message){
		echo "works";
		die;
		// echo "Email sending started <br/>";
		$time=date('Y-m-d');
			$config = array(
			'protocol' => 'smtp',
		...
		$this->email->from('joshuamareka@gmail.com', 'Senders Name');
	...
	public function send_email_func($email_address=NULL,$message=NULL,$subject=NULL,$attach_file=NULL,$bcc_email=NULL,$cc_email=NULL){
		//echo $message;EXIT;
		//echo $subject;EXIT;
		//echo $attach_file;exit;		        
		//echo $message.'</br>'.$subject.'</br>'.$attach_file;exit;	
		$fromm = 'oscarstestemail@gmail.com';
		$messages=$message;
		...
		$config['smtp_pass']    = 'joshuaSUN';//healthkenya //hcmpkenya@gmail.com
